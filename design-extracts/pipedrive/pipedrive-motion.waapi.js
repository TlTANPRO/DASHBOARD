...
//   import { animations } from './pipedrive.com-motion.waapi.js';
...
export const easings = {
  custom1: 'cubic-bezier(0.4, 0, 0.2, 1)', // 22× on page
  easeInOut: 'ease', // 10× on page
};
...
export const keyframes = {
  onetrustFadeIn: [{"opacity":"0","offset":0},{"opacity":"1","offset":1}],
};
...
const _timing = { duration: 320, easing: easings.custom1, fill: 'both' };
