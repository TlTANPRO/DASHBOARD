...
// 2026-07-26T12:47:38.380Z
//
//   import gsap from 'gsap';
//   import { registerEases, reveals } from './pipedrive.com-motion.gsap.js';
...
export const eases = {
  custom1: 'M0,0 C0.4,0 0.2,1 1,1', // 22× on page
  easeInOut: 'M0,0 C0.25,0.1 0.25,1 1,1', // 10× on page
};
...
export const reveals = {
  fadeIn: (target, vars = {}) => gsap.from(target, { opacity: 0, duration: 0.32, ease: 'custom1', ...vars }),
  slideUp: (target, vars = {}) => gsap.from(target, { opacity: 0, y: 24, duration: 0.32, ease: 'custom1', ...vars }),
  slideDown: (target, vars = {}) => gsap.from(target, { opacity: 0, y: -24, duration: 0.32, ease: 'custom1', ...vars }),
  scaleIn: (target, vars = {}) => gsap.from(target, { opacity: 0, scale: 0.96, duration: 0.32, ease: 'custom1', ...vars }),
  pop: (target, vars = {}) => gsap.from(target, { scale: 0.9, duration: 0.32, ease: 'custom1', ...vars }),
};
...
export function revealOnScroll(targets, vars = {}) {
  return gsap.utils.toArray(targets).map((el) =>
    gsap.from(el, {
      opacity: 0, y: 24, duration: 0.32, ease: 'custom1', ...vars,
