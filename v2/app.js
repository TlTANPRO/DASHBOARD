  ...
  try {
    ...
    if (rows.length === 0) {
      list.innerHTML = `<div class="empty-state">
        ...
        <p>Klik "+ Tambah Program" untuk input.</p>
      </div>`;
      return;
    }
    list.innerHTML = `<table class="crud-table">
...
function renderLeaderboard() {
  ...
  if (!html) html = `<div class="empty-state"><h3>Belum ada data KPI</h3><p>Login + tambah KPI untuk auto-generate leaderboard.</p></div>`;
  grid.innerHTML = html;
}
